...
export type IconsGeneralCartIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function IconsGeneralCartIcon(props: IconsGeneralCartIconProps) {
...
export default IconsGeneralCartIcon;
/* prettier-ignore-end */
